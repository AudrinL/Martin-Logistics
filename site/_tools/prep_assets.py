...
ASSETS = os.path.join(os.path.dirname(ROOT), "Martin logistics Assets")
IMG = os.path.join(ROOT, "assets", "img")
SEQ = os.path.join(ROOT, "assets", "seq")
...
# ── Logos ──────────────────────────────────────────────────────────────────
LOGOS = {
    "Martin logistics logo white truck perfect logo.png": "logo-light",   # for dark bg
    "Martin logistics logo black truck perfect logo.png": "logo-dark",    # for paper bg
}
