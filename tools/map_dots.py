...
SRC = os.path.join(ROOT, "Martin logistics Assets", "africa map.jpg")
...
dest = os.path.join(ROOT, "public", "assets", "africa-dots.json")
...
chk.save(os.path.join(HERE, "_mapcheck.png"))
print("wrote tools/_mapcheck.png")
